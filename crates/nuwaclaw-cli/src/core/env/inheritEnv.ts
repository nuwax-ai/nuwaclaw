 ...
 *
 * The whole point of nuwaclaw is to NOT do what the Electron client does
...
/** Vars that belong to nuwaclaw's own process, not the user's shell — never pass these through. */
const STRIP_VARS = [
