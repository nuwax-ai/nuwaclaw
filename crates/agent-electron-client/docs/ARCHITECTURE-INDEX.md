...
| 文档 | 描述 | 优先级 |
|------|------|--------|
| [总览](./ARCHITECTURE-OVERVIEW.md) | 产品定位、核心原则、系统架构图 | P0 |
| [核心组件](./ARCHITECTURE-COMPONENTS.md) | Memory、Skill Creator、EvoMap、Soul.md | P0 |
| [循环流程](./ARCHITECTURE-LOOP.md) | 七层循环、接口定义、数据流 | P0 |
| [存储实现](./ARCHITECTURE-STORAGE.md) | Markdown 格式、索引机制、读写接口 | P0 |
| [隔离策略](./ARCHITECTURE-ISOLATION.md) | 三区模型、环境变量、安全边界 | P0 |

### 参考文档

| 文档 | 描述 | 类型 |
|------|------|------|
| [OpenClaw 参考](./ARCHITECTURE-REF-OPENCLAW.md) | openclaw 架构分析与改进建议 | reference |
| [运行时环境配置](./ARCHITECTURE-RUNTIME-ENV-PROFILES.md) | strict/compat 环境配置策略 | design |
...
1. **[总览](./ARCHITECTURE-OVERVIEW.md)** - 了解产品定位和核心原则
2. **[核心组件](./ARCHITECTURE-COMPONENTS.md)** - 理解四大核心组件
3. **[循环流程](./ARCHITECTURE-LOOP.md)** - 掌握完整循环流程
4. **[存储实现](./ARCHITECTURE-STORAGE.md)** - 了解数据存储方式

### 架构师/高级开发者

1. **[总览](./ARCHITECTURE-OVERVIEW.md)** - 快速回顾
2. **[隔离策略](./ARCHITECTURE-ISOLATION.md)** - 理解安全边界
3. **[OpenClaw 参考](./ARCHITECTURE-REF-OPENCLAW.md)** - 参考优秀设计
4. **[运行时环境配置](./ARCHITECTURE-RUNTIME-ENV-PROFILES.md)** - 环境配置细节

### 运维/安全工程师

1. **[隔离策略](./ARCHITECTURE-ISOLATION.md)** - 安全隔离机制
