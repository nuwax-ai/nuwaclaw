...
- [总览](./ARCHITECTURE-OVERVIEW.md) - 产品定位、核心原则
- [核心组件](./ARCHITECTURE-COMPONENTS.md) - Memory、Skill Creator、EvoMap、Soul.md
- [存储实现](./ARCHITECTURE-STORAGE.md) - Markdown 格式、索引机制
- [隔离策略](./ARCHITECTURE-ISOLATION.md) - 三区模型、环境变量
