...
export type PromptEnhancer = (basePrompt: string | undefined) => string | undefined;
...
export function enhanceSystemPrompt(basePrompt: string | undefined): string | undefined {
