...
describe("validateInputAction", () => {
  it("rejects missing action", () => {
    expect(() => validateInputAction({})).toThrow(
      "Missing or invalid action object",
    );
  });

  it("rejects non-object action", () => {
    expect(() => validateInputAction({ action: "string" })).toThrow(
      "Missing or invalid action object",
    );
  });

  it("rejects array action", () => {
    expect(() => validateInputAction({ action: [1, 2] })).toThrow(
      "Missing or invalid action object",
    );
  });
  ...
  it("rejects invalid action type", () => {
    expect(() =>
      validateInputAction({ action: { type: "invalid_type" } }),
    ).toThrow("Invalid action type");
  });

  it("rejects action with missing type", () => {
    expect(() => validateInputAction({ action: { x: 1 } })).toThrow(
      "Invalid action type",
    );
  });
  ...
  it("rejects mouse_move without x", () => {
    expect(() =>
      validateInputAction({ action: { type: "mouse_move", y: 200 } }),
    ).toThrow("x must be a finite number");
  });

  it("rejects mouse_move with string x", () => {
    expect(() =>
      validateInputAction({ action: { type: "mouse_move", x: "100", y: 200 } }),
    ).toThrow("x must be a finite number");
  });
  ...
  it("accepts valid mouse_click", () => {
    const result = validateInputAction({
      action: { type: "mouse_click", x: 50, y: 50 },
    });
  ...
  it("accepts mouse_click with optional button", () => {
    const result = validateInputAction({
      action: { type: "mouse_click", x: 50, y: 50, button: "right" },
    });
    expect(result.type).toBe("mouse_click");
  });
  ...
  it("accepts valid mouse_scroll", () => {
    const result = validateInputAction({
      action: { type: "mouse_scroll", x: 100, y: 100, deltaY: 3 },
    });
  ...
  it("rejects mouse_scroll without deltaY", () => {
    expect(() =>
      validateInputAction({ action: { type: "mouse_scroll", x: 100, y: 100 } }),
  ...
  it("accepts valid keyboard_type", () => {
    const result = validateInputAction({
      action: { type: "keyboard_type", text: "hello" },
    });
  ...
  it("rejects keyboard_type without text", () => {
    expect(() =>
      validateInputAction({ action: { type: "keyboard_type" } }),
    ).toThrow("keyboard_type requires string text");
  });

  it("rejects keyboard_type with numeric text", () => {
    expect(() =>
      validateInputAction({ action: { type: "keyboard_type", text: 123 } }),
    ).toThrow("keyboard_type requires string text");
  });
  ...
  it("accepts valid keyboard_press", () => {
    const result = validateInputAction({
      action: { type: "keyboard_press", key: "enter" },
    });
  ...
  it("rejects keyboard_press without key", () => {
    expect(() =>
      validateInputAction({ action: { type: "keyboard_press" } }),
  ...
  it("accepts valid keyboard_hotkey", () => {
    const result = validateInputAction({
      action: { type: "keyboard_hotkey", keys: ["ctrl", "c"] },
    });
  ...
  it("rejects keyboard_hotkey without keys", () => {
    expect(() =>
      validateInputAction({ action: { type: "keyboard_hotkey" } }),
  ...
  it("rejects keyboard_hotkey with non-string keys", () => {
    expect(() =>
      validateInputAction({
        action: { type: "keyboard_hotkey", keys: [1, 2] },
      }),
    ).toThrow("keyboard_hotkey requires string[] keys");
  });
  ...
  it("rejects NaN coordinates", () => {
    expect(() =>
      validateInputAction({ action: { type: "mouse_move", x: NaN, y: 100 } }),
    ).toThrow("x must be a finite number");
  });
  ...
  it("rejects Infinity coordinates", () => {
    expect(() =>
      validateInputAction({
        action: { type: "mouse_move", x: Infinity, y: 100 },
      }),
    ).toThrow("x must be a finite number");
  });
  ...
  it("rejects out-of-range coordinates", () => {
    expect(() =>
      validateInputAction({
        action: { type: "mouse_move", x: 200000, y: 100 },
      }),
  ...
  it("rejects keyboard_type with text exceeding max length", () => {
    ...
    expect(() =>
      validateInputAction({
        action: { type: "keyboard_type", text: longText },
      }),
  ...
  it("blocks dangerous key combinations", () => {
    expect(() =>
      validateInputAction({
        action: { type: "keyboard_hotkey", keys: ["cmd", "q"] },
      }),
  ...
  it("blocks alt+f4", () => {
    expect(() =>
      validateInputAction({
        action: { type: "keyboard_hotkey", keys: ["alt", "f4"] },
      }),
    ).toThrow("blocked for safety");
  });
});
...
describe("validateScreenshotRequest", () => {
  ...
  it("rejects non-numeric scale", () => {
    expect(() => validateScreenshotRequest({ scale: "0.5" })).toThrow(
  ...
  it("rejects invalid format", () => {
    expect(() => validateScreenshotRequest({ format: "bmp" })).toThrow(
  ...
  it("rejects non-numeric quality", () => {
    expect(() => validateScreenshotRequest({ quality: "high" })).toThrow(
  ...
  it("rejects non-numeric displayIndex", () => {
    expect(() => validateScreenshotRequest({ displayIndex: "1" })).toThrow(
  ...
  it("rejects region with missing fields", () => {
    expect(() => validateScreenshotRequest({ region: { x: 0, y: 0 } })).toThrow(
      "region must have numeric x, y, width, height",
    );
  });

  it("rejects non-object region", () => {
    expect(() => validateScreenshotRequest({ region: "full" })).toThrow(
      "region must have numeric x, y, width, height",
    );
  });
