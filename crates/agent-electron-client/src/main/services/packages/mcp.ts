...
import { getBundledMcpProxyDir, isInstalledLocally } from "./packageLocator";
...
import { loadMcpProxyHostAdapter } from "./mcpHostAdapterLoader";
...
class McpProxyManager {
  ...
  > | null {
    ...
    if (scriptPath) {
      ...
      const result = loadMcpProxyHostAdapter().rewriteServersToProxyCommands(
        hostMap,
        {
    ...
    return loadMcpProxyHostAdapter().rewriteServersToProxyCommands(hostMap, {
