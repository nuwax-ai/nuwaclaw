...
export type InputAction =
  ...
  | { type: 'mouse_drag'; startX: number; startY: number; endX: number; endY: number; button?: MouseButton }
...
export type GuiPermissionState = 'granted' | 'denied' | 'not_determined' | 'not_needed' | 'unknown';
