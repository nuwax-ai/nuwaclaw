...
console.log('  - APPLE_TEAM_ID: 公证用的 Team ID');
console.log('  - APPLE_API_KEY: 公证用的 API Key (可选)');
console.log('  - APPLE_API_KEY_ID: API Key ID (可选)');
console.log('  - APPLE_API_ISSUER: API Issuer ID (可选)\n');
