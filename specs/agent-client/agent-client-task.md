...
> **说明**：
> - **阶段一（当前优先级）**：Phase 1-3，目标是验证通信能力和基础 UI
...
2. P0-1.2.1 ~ P0-1.2.5：基础 UI 框架、状态栏
3. P0-1.3.1 ~ P0-1.3.2：托盘功能
4. P0-1.4.1 ~ P0-1.4.2：开机自启动
5. P0-2.1.1 ~ P0-2.1.4：连接管理、心跳保活、重连
6. P0-2.2.1 ~ P0-2.2.2：业务通道
7. P0-2.3.1 ~ P0-2.3.4：设置界面
8. P0-2.4.1 ~ P0-2.4.2：客户端信息显示
...
> **说明**：Milestone 1-3 属于阶段一（当前开发），Milestone 4-5 属于阶段二（后续开发）
